...
public:
	...
	explicit Item(bool _singleUse, Box2DWorld * _world, int16 _categoryBits = PuppetGame::kITEM, int16 _maskBits = -1, int16 _groupIndex = 0, int _damage = 5.f, float _handleX = 0.f, float _handleY = 0.f);
	~Item();
