...
Texture * PuppetResourceManager::startupSplash = new Texture("assets/hurly-burly/SplashMessages/Startup.png", true, false);
Texture * PuppetResourceManager::blank = new Texture("assets/hurly-burly/blank.png", true, false);
TextureSampler * PuppetResourceManager::itemNone = new TextureSampler(new Texture("assets/hurly-burly/blank.png", true, false), 1, 1);

Texture * PuppetResourceManager::stageFloor = new Texture("assets/hurly-burly/StageFloor.png", true, false);
Texture * PuppetResourceManager::stageFront = new Texture("assets/hurly-burly/StageFront.png", true, false);
Texture * PuppetResourceManager::sky		= new Texture("assets/hurly-burly/Sky.png", true, false);

Texture * PuppetResourceManager::tree1  = new Texture("assets/hurly-burly/Foliage/Tree1.png", true, false);
Texture * PuppetResourceManager::tree2	= new Texture("assets/hurly-burly/Foliage/Tree2.png", true, false);
Texture * PuppetResourceManager::bush1	= new Texture("assets/hurly-burly/Foliage/Bush1.png", true, false);
Texture * PuppetResourceManager::bush2	= new Texture("assets/hurly-burly/Foliage/Bush2.png", true, false);
Texture * PuppetResourceManager::sun	= new Texture("assets/hurly-burly/Sun.png", true, false);

Texture * PuppetResourceManager::cloud1 = new Texture("assets/hurly-burly/Clouds/Cloud1.png", true, false);
Texture * PuppetResourceManager::cloud2 = new Texture("assets/hurly-burly/Clouds/Cloud2.png", true, false);
Texture * PuppetResourceManager::cloud3 = new Texture("assets/hurly-burly/Clouds/Cloud3.png", true, false);
Texture * PuppetResourceManager::cloud4 = new Texture("assets/hurly-burly/Clouds/Cloud4.png", true, false);
...
void PuppetResourceManager::init(){
	...
	countDown0 = new TextureSampler(new Texture("assets/hurly-burly/Countdown/0.png", true, false), 1024, 1024);
	countDown1 = new TextureSampler(new Texture("assets/hurly-burly/Countdown/1.png", true, false), 1024, 1024);
	countDown2 = new TextureSampler(new Texture("assets/hurly-burly/Countdown/2.png", true, false), 1024, 1024);
	countDown3 = new TextureSampler(new Texture("assets/hurly-burly/Countdown/3.png", true, false), 1024, 1024);
	countDown4 = new TextureSampler(new Texture("assets/hurly-burly/Countdown/4.png", true, false), 1024, 1024);
	countDown5 = new TextureSampler(new Texture("assets/hurly-burly/Countdown/5.png", true, false), 1024, 1024);
	...
	scoreIndicators.push_back(new Texture("assets/hurly-burly/PlayerIndicators/indicator1-circle.png", true, false));
	scoreIndicators.push_back(new Texture("assets/hurly-burly/PlayerIndicators/indicator2-circle.png", true, false));
	scoreIndicators.push_back(new Texture("assets/hurly-burly/PlayerIndicators/indicator3-circle.png", true, false));
	scoreIndicators.push_back(new Texture("assets/hurly-burly/PlayerIndicators/indicator4-circle.png", true, false));
	for(auto i : scoreIndicators){
		resources.push_back(i);
	}

	winSplashes.push_back(new TextureSampler(new Texture("assets/hurly-burly/VictorySplashMessages/yellowWins.png", true, false), 1024, 1024));
	winSplashes.push_back(new TextureSampler(new Texture("assets/hurly-burly/VictorySplashMessages/greenWins.png", true, false), 1024, 1024));
	winSplashes.push_back(new TextureSampler(new Texture("assets/hurly-burly/VictorySplashMessages/blueWins.png", true, false), 1024, 1024));
	winSplashes.push_back(new TextureSampler(new Texture("assets/hurly-burly/VictorySplashMessages/redWins.png", true, false), 1024, 1024));
