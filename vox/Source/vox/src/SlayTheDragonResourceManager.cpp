...
Texture * SlayTheDragonResourceManager::fortificationSpriteSheet	= new Texture("assets/hurly-burly/Fortification/FortSpriteSheet.png", true, false);
...
void SlayTheDragonResourceManager::init(){
	...
	splashMessage	= new TextureSampler(new Texture("assets/hurly-burly/SplashMessages/SlayTheDragon.png", true, false), 1024, 1024);
	
	fortBackground	= new TextureSampler(new Texture("assets/hurly-burly/Fortification/FortBackground.png", true, false), 453, 307);
	fortForeground	= new TextureSampler(new Texture("assets/hurly-burly/Fortification/FortForeground.png", true, false), 1024, 413);
	fortStructure	= new TextureSampler(new Texture("assets/hurly-burly/Fortification/FortStructure.png", true, false), 683, 127);
	archerTorso		= new TextureSampler(new Texture("assets/hurly-burly/ArcherAssets/ArcherTorso.png", true, false), 275, 765);
	archerArm		= new TextureSampler(new Texture("assets/hurly-burly/ArcherAssets/ArcherArm.png", true, false), 64, 228);
	archerHat		= new TextureSampler(new Texture("assets/hurly-burly/ArcherAssets/ArcherHat.png", true, false), 191, 275);
