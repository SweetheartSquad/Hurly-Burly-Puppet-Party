	...
	altitude(60.f)
{
	...
	lhlej.localAnchorA.Set(-0.5f * armLeft->getCorrectedWidth(), -0.1f * armLeft->getCorrectedHeight());
	lhlej.localAnchorB.Set(-0.3f * handLeft->getCorrectedWidth(), 0.4f * handLeft->getCorrectedHeight());
